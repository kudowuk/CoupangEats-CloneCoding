...
import com.example.demo.src.cart.model.PostCartDetailReq;
...
//    }
    ...
    public PostCartRes createCart(int userIdx, PostCartReq postCartReq) throws BaseException {
        try {
            ...
            for (PostCartDetailReq postCartDetailReq : postCartReq.getCartMenuList()){
                cartDao.createCartDetail(cartIdx, postCartDetailReq);
            }
